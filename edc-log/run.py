...
if __name__ == "__main__":
    ...
    # OIE module setting
    parser.add_argument(
        "--oie_llm", default="glm-5.2", help="LLM used for open information extraction."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--sd_llm", default="glm-5.2", help="LLM used for schema definition."
    )
    parser.add_argument(
    ...
    parser.add_argument("--ee_llm", default="glm-5.2", help="LLM used for entity extraction.")
    parser.add_argument(
